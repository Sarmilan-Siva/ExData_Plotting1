#the following codes will plot 'Plot 02 - Global Active Power variation with time'
...
#plot - Line graph
plot(DataNeeded$contTime, DataNeeded$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.copy(png, file = "Plots/plot2.png", width = 480, height = 480) ## Copy the plot to a PNG file
